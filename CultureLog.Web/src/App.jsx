...
function App() {
  ...
  const handleSearch = async () => {
    if (!query) return;
    try {
      const response = await fetch(`https://culturelog-api.onrender.com/api/Search/${query}`);
  ...
  const handleSave = async (item) => {
    ...
    try {
      const response = await fetch('https://culturelog-api.onrender.com/api/Review', {
        method: 'POST',
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      const response = await fetch(`https://culturelog-api.onrender.com/api/Review/${id}`, {
        method: 'DELETE',
      });
